...
#
# Script generated by Vivado on Sun Mar 09 14:33:41 +0100 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : counter_32.sh
...
#
# Usage        : counter_32.sh
#                counter_32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                counter_32.sh [-reset_run]
#                counter_32.sh [-reset_log]
#                counter_32.sh [-help]
#
...
#                script (type 'counter_32.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_13 -libname c_reg_fd_v12_0_9 -libname xbip_dsp48_wrapper_v3_0_6 -libname xbip_pipe_v3_0_9 -libname xbip_dsp48_addsub_v3_0_9 -libname xbip_addsub_v3_0_9 -libname c_addsub_v12_0_18 -libname c_gate_bit_v12_0_9 -libname xbip_counter_v3_0_9 -libname c_counter_binary_v12_0_19 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_13 c_reg_fd_v12_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_pipe_v3_0_9 xbip_dsp48_addsub_v3_0_9 xbip_addsub_v3_0_9 c_addsub_v12_0_18 c_gate_bit_v12_0_9 xbip_counter_v3_0_9 c_counter_binary_v12_0_19 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "counter_32.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./counter_32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work c_gate_bit_v12_0_9 $xmvhdl_opts \
  "../../../ipstatic/hdl/c_gate_bit_v12_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work xbip_counter_v3_0_9 $xmvhdl_opts \
  "../../../ipstatic/hdl/xbip_counter_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work c_counter_binary_v12_0_19 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.counter_32
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.counter_32 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log counter_32_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./counter_32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: counter_32.sh [-help]\n\
Usage: counter_32.sh [-step]\n\
Usage: counter_32.sh [-lib_map_path]\n\
Usage: counter_32.sh [-reset_run]\n\
Usage: counter_32.sh [-reset_log]\n\
Usage: counter_32.sh [-keep_index]\n\
Usage: counter_32.sh [-noclean_files]\n\n\
