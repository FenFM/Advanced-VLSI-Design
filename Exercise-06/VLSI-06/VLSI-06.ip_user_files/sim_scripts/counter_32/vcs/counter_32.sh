...
design_libs=(xbip_utils_v3_0_13 c_reg_fd_v12_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_pipe_v3_0_9 xbip_dsp48_addsub_v3_0_9 xbip_addsub_v3_0_9 c_addsub_v12_0_18 c_gate_bit_v12_0_9 xbip_counter_v3_0_9 c_counter_binary_v12_0_19 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work c_gate_bit_v12_0_9 $vhdlan_opts \
  "../../../ipstatic/hdl/c_gate_bit_v12_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vhdlan -work xbip_counter_v3_0_9 $vhdlan_opts \
  "../../../ipstatic/hdl/xbip_counter_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vhdlan -work c_counter_binary_v12_0_19 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.counter_32 -o counter_32_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./counter_32_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key counter_32_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc counter_32_simv.daidir vcs_lib c.obj)
