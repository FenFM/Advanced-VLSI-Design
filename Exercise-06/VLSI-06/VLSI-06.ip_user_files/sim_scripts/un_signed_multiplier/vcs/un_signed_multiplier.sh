...
#                script (type 'un_signed_multiplier.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.un_signed_multiplier -o un_signed_multiplier_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./un_signed_multiplier_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key un_signed_multiplier_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc un_signed_multiplier_simv.daidir vcs_lib c.obj)
