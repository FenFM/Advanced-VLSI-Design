...
#
# Script generated by Vivado on Mon Mar 10 07:50:37 +0100 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : un_signed_multiplier.sh
...
#
# Usage        : un_signed_multiplier.sh
#                un_signed_multiplier.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                un_signed_multiplier.sh [-reset_run]
#                un_signed_multiplier.sh [-reset_log]
#                un_signed_multiplier.sh [-help]
#
...
# script info
echo -e "un_signed_multiplier.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./un_signed_multiplier.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L xbip_pipe_v3_0_9 -L xbip_bram18k_v3_0_9 -L mult_gen_v12_0_21 -L xil_defaultlib -L secureip -L xpm --snapshot un_signed_multiplier xil_defaultlib.un_signed_multiplier -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim un_signed_multiplier -key {Behavioral:sim_1:Functional:un_signed_multiplier} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb un_signed_multiplier.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./un_signed_multiplier.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: un_signed_multiplier.sh [-help]\n\
Usage: un_signed_multiplier.sh [-step]\n\
Usage: un_signed_multiplier.sh [-lib_map_path]\n\
Usage: un_signed_multiplier.sh [-reset_run]\n\
Usage: un_signed_multiplier.sh [-reset_log]\n\
Usage: un_signed_multiplier.sh [-keep_index]\n\
Usage: un_signed_multiplier.sh [-noclean_files]\n\n\
