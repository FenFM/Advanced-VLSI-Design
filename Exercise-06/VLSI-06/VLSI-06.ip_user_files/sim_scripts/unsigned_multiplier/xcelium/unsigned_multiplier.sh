...
#
# Script generated by Vivado on Mon Mar 10 07:50:26 +0100 2025
...
#
# Usage        : unsigned_multiplier.sh
#                unsigned_multiplier.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                unsigned_multiplier.sh [-reset_run]
#                unsigned_multiplier.sh [-reset_log]
#                unsigned_multiplier.sh [-help]
#
...
#                script (type 'unsigned_multiplier.sh -help' for more information).
#
...
# script info
echo -e "unsigned_multiplier.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./unsigned_multiplier.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.unsigned_multiplier
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.unsigned_multiplier -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log unsigned_multiplier_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: unsigned_multiplier.sh [-step]\n\
Usage: unsigned_multiplier.sh [-lib_map_path]\n\
Usage: unsigned_multiplier.sh [-reset_run]\n\
Usage: unsigned_multiplier.sh [-reset_log]\n\
Usage: unsigned_multiplier.sh [-keep_index]\n\
