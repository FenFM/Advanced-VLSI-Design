...
#
# Script generated by Vivado on Sun Mar 09 13:14:11 +0100 2025
...
#
# Usage        : signed_divider.sh
#                signed_divider.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                signed_divider.sh [-reset_run]
#                signed_divider.sh [-reset_log]
#                signed_divider.sh [-help]
#
...
#                script (type 'signed_divider.sh -help' for more information).
#
...
# script info
echo -e "signed_divider.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./signed_divider.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.signed_divider
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.signed_divider -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log signed_divider_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: signed_divider.sh [-step]\n\
Usage: signed_divider.sh [-lib_map_path]\n\
Usage: signed_divider.sh [-reset_run]\n\
Usage: signed_divider.sh [-reset_log]\n\
Usage: signed_divider.sh [-keep_index]\n\
