...
#
# Script generated by Vivado on Sun Mar 09 14:31:01 +0100 2025
...
#
# Usage        : signed_adder.sh
#                signed_adder.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                signed_adder.sh [-reset_run]
#                signed_adder.sh [-reset_log]
#                signed_adder.sh [-help]
#
...
#                script (type 'signed_adder.sh -help' for more information).
#
...
# script info
echo -e "signed_adder.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./signed_adder.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.signed_adder
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.signed_adder -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log signed_adder_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: signed_adder.sh [-step]\n\
Usage: signed_adder.sh [-lib_map_path]\n\
Usage: signed_adder.sh [-reset_run]\n\
Usage: signed_adder.sh [-reset_log]\n\
Usage: signed_adder.sh [-keep_index]\n\
