...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L c_reg_fd_v12_0_9 -L xbip_dsp48_wrapper_v3_0_6 -L xbip_pipe_v3_0_9 -L xbip_dsp48_addsub_v3_0_9 -L xbip_addsub_v3_0_9 -L c_addsub_v12_0_18 -L xil_defaultlib -L secureip -L xpm --snapshot signed_adder_33 xil_defaultlib.signed_adder_33 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim signed_adder_33 -key {Behavioral:sim_1:Functional:signed_adder_33} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb signed_adder_33.wdb xsim.dir libdpi.so)
