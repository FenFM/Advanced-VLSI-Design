...
#
# Script generated by Vivado on Sun Mar 09 18:22:56 +0100 2025
...
#
# Usage        : unsigned_divider.sh
#                unsigned_divider.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                unsigned_divider.sh [-reset_run]
#                unsigned_divider.sh [-reset_log]
#                unsigned_divider.sh [-help]
#
...
#                script (type 'unsigned_divider.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_13 -libname axi_utils_v2_0_9 -libname xbip_pipe_v3_0_9 -libname xbip_dsp48_wrapper_v3_0_6 -libname xbip_dsp48_addsub_v3_0_9 -libname xbip_bram18k_v3_0_9 -libname mult_gen_v12_0_21 -libname floating_point_v7_0_23 -libname xbip_dsp48_mult_v3_0_9 -libname xbip_dsp48_multadd_v3_0_9 -libname div_gen_v5_1_22 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 floating_point_v7_0_23 xbip_dsp48_mult_v3_0_9 xbip_dsp48_multadd_v3_0_9 div_gen_v5_1_22 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "unsigned_divider.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./unsigned_divider.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.unsigned_divider
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.unsigned_divider -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log unsigned_divider_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: unsigned_divider.sh [-step]\n\
Usage: unsigned_divider.sh [-lib_map_path]\n\
Usage: unsigned_divider.sh [-reset_run]\n\
Usage: unsigned_divider.sh [-reset_log]\n\
Usage: unsigned_divider.sh [-keep_index]\n\
