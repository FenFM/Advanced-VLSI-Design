...
#
# Script generated by Vivado on Sun Mar 09 14:31:56 +0100 2025
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : unsigned_adder.sh
...
#
# Usage        : unsigned_adder.sh
#                unsigned_adder.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                unsigned_adder.sh [-reset_run]
#                unsigned_adder.sh [-reset_log]
#                unsigned_adder.sh [-help]
#
...
#                script (type 'unsigned_adder.sh -help' for more information).
#
...
# script info
echo -e "unsigned_adder.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./unsigned_adder.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.unsigned_adder
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.unsigned_adder -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log unsigned_adder_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./unsigned_adder.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: unsigned_adder.sh [-help]\n\
Usage: unsigned_adder.sh [-step]\n\
Usage: unsigned_adder.sh [-lib_map_path]\n\
Usage: unsigned_adder.sh [-reset_run]\n\
Usage: unsigned_adder.sh [-reset_log]\n\
Usage: unsigned_adder.sh [-keep_index]\n\
Usage: unsigned_adder.sh [-noclean_files]\n\n\
