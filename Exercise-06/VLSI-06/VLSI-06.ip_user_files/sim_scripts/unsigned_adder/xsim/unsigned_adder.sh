...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L c_reg_fd_v12_0_9 -L xbip_dsp48_wrapper_v3_0_6 -L xbip_pipe_v3_0_9 -L xbip_dsp48_addsub_v3_0_9 -L xbip_addsub_v3_0_9 -L c_addsub_v12_0_18 -L xil_defaultlib -L secureip -L xpm --snapshot unsigned_adder xil_defaultlib.unsigned_adder -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim unsigned_adder -key {Behavioral:sim_1:Functional:unsigned_adder} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb unsigned_adder.wdb xsim.dir libdpi.so)
