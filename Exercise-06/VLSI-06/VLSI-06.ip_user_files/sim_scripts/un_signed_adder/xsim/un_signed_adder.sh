...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_13 -L c_reg_fd_v12_0_9 -L xbip_dsp48_wrapper_v3_0_6 -L xbip_pipe_v3_0_9 -L xbip_dsp48_addsub_v3_0_9 -L xbip_addsub_v3_0_9 -L c_addsub_v12_0_18 -L xil_defaultlib -L secureip -L xpm --snapshot un_signed_adder xil_defaultlib.un_signed_adder -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim un_signed_adder -key {Behavioral:sim_1:Functional:un_signed_adder} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb un_signed_adder.wdb xsim.dir libdpi.so)
