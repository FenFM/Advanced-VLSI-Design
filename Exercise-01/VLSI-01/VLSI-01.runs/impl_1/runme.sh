...
HD_PWD='C:/Users/fenja/Projekte/Advanced-VLSI-Design/Exercise-01/VLSI-01/VLSI-01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and3_wrapper.tcl -notrace
