...
HD_PWD='C:/Users/fenja/Projekte/Advanced-VLSI-Design/Exercise-01/vivado/VHDL-Exercise/VHDL-Exercise.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log and3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source and3.tcl -notrace
