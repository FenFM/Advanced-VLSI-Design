...
HD_PWD='C:/Users/fenja/Projekte/Advanced-VLSI-Design/Exercise-01/vivado/VHDL-Exercise/VHDL-Exercise.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log and3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source and3.tcl
