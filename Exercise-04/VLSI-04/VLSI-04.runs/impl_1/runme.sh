...
HD_PWD='C:/Users/fenja/Projekte/Advanced-VLSI-Design/Exercise-04/VLSI-04/VLSI-04.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log register_file_timing_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source register_file_timing_wrapper.tcl -notrace
