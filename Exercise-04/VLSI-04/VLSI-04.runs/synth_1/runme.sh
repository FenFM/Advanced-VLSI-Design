...
HD_PWD='C:/Users/fenja/Projekte/Advanced-VLSI-Design/Exercise-04/VLSI-04/VLSI-04.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log register_file_timing_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source register_file_timing_wrapper.tcl
